...
public final class ActivityOtpBinding implements ViewBinding {
  ...
  private ActivityOtpBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull EditText editTextNumber, @NonNull ImageView imageView2,
      @NonNull ImageView imageView5, @NonNull TextView textView2, @NonNull TextView textView5,
  ...
  public static ActivityOtpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOtpBinding((ConstraintLayout) rootView, button, editTextNumber, imageView2,
          imageView5, textView2, textView5, textView7);
    }
